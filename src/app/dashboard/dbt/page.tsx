...
export default function DbtSkillsPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="font-display text-3xl font-medium">DBT skills</h1>
        <p className="mt-1 text-navy-500 dark:text-white/60">
          Dialectical Behavior Therapy skills — distress tolerance, emotion regulation, interpersonal effectiveness, and mindfulness.
        </p>
      </div>

      <div className="flex flex-wrap gap-2">
        {DBT_WORKSHEETS.map((w) => (
          <button
            key={w.type}
